...
const COURSE_PATTERNS: CoursePattern[] = [
  ...
  { courseId: "civil-iii-reales", keywords: ["derechos reales", "propiedad", "posesión", "posicion", "usucapión", "usucapion", "hipoteca", "prenda"], weight: 3 },
  ...
  { courseId: "derechos-humanos", keywords: ["derechos humanos", "derecho internacional de los derechos humanos", "convención americana", "convencion americana", "corte interamericana"], weight: 3 },
  { courseId: "penal-general-i", keywords: ["teoría del delito", "teoria del delito", "tipicidad", "antijuridicidad", "culpabilidad", "dolo", "imprudencia", "penal general"], weight: 2 },
  { courseId: "penal-general-ii", keywords: ["concurso de delitos", "penas", "consecuencias jurídicas", "reincidencia", "suspensión de pena"], weight: 2 },
  ...
  { courseId: "procesal-penal-iii", keywords: ["casación penal", "ejecución penal", "ejecucion penal", "libertad condicional"], weight: 2 },
  { courseId: "teoria-general-proceso", keywords: ["teoría general del proceso", "teoria general del proceso", "jurisdicción", "jurisdiccion", "competencia", "litigio", "principios procesales"], weight: 3 },
  ...
  { courseId: "trabajo-i", keywords: ["contrato de trabajo", "relación laboral", "relacion laboral", "derecho del trabajo", "jornada laboral"], weight: 2 },
  { courseId: "trabajo-ii", keywords: ["despido", "sindicato", "negociación colectiva", "negociacion colectiva", "seguridad social"], weight: 2 },
  { courseId: "procesal-trabajo", keywords: ["proceso laboral", "demanda laboral", "reinstalación", "reinstalacion laboral"], weight: 3 },
  { courseId: "empresarial-i-societario", keywords: ["sociedad", "societario", "sociedad anónima", "sociedad anonima", "junta general", "accionista"], weight: 3 },
  { courseId: "empresarial-ii-titulos-valores", keywords: ["título valor", "titulo valor", "letra de cambio", "pagare", "pagaré", "cheque"], weight: 3 },
  { courseId: "empresarial-iii-concursal", keywords: ["concurso de acreedores", "quiebra", "derecho concursal", "liquidación", "liquidacion"], weight: 3 },
  ...
  { courseId: "derecho-romano", keywords: ["derecho romano", "justinianeo", "persona romana", "obligatio", "actio"], weight: 3 },
  { courseId: "historia-derecho-peru-latam", keywords: ["historia del derecho", "derecho peruano", "derecho latinoamericano", "codificación", "codificacion"], weight: 2 },
  ...
  { courseId: "contrataciones-estado", keywords: ["contrataciones del estado", "licitación", "licitacion", "osce", "seace"], weight: 3 },
  { courseId: "derecho-economico", keywords: ["derecho económico", "derecho economico", "libre competencia", "indecopi", "defensa de la competencia"], weight: 3 },
  { courseId: "derecho-integracion", keywords: ["integración andina", "integracion andina", "comunidad andina", "unión aduanera"], weight: 3 },
  { courseId: "medicina-legal", keywords: ["medicina legal", "lesiones", "necropsia", "balística", "balistica"], weight: 3 },
...
export function detectCourseFromText(text: string): CourseDetectionResult | null {
  ...
  if (!scores.length) {
    const fallback = getAllCycles()[2]?.courses[0];
