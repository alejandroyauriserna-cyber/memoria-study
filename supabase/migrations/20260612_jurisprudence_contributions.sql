-- MEMORIASTUDY · Aportes comunitarios a Biblioteca Jurídica
-- Ejecutar en Supabase SQL Editor DESPUÉS de jurisprudence-library-complete.sql
...
drop policy if exists "Users update own pending jurisprudence" on public.jurisprudence_documents;
create policy "Users update own pending jurisprudence"
on public.jurisprudence_documents for update
to authenticated
...
drop policy if exists "Users delete own jurisprudence pdfs" on storage.objects;
create policy "Users delete own jurisprudence pdfs"
