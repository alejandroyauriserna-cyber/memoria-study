-- Biblioteca Jurídica: esquema + seed (ver supabase/jurisprudence-library-complete.sql para pegar en SQL Editor)
...
create index if not exists jurisprudence_documents_materia_idx on public.jurisprudence_documents(materia);
create index if not exists jurisprudence_documents_tipo_idx on public.jurisprudence_documents(tipo);
create index if not exists jurisprudence_documents_year_idx on public.jurisprudence_documents(year desc);
create index if not exists jurisprudence_documents_organo_idx on public.jurisprudence_documents(organo);
create index if not exists jurisprudence_documents_keywords_gin_idx on public.jurisprudence_documents using gin(keywords);
create index if not exists jurisprudence_documents_search_vector_idx on public.jurisprudence_documents using gin(search_vector);
...
on public.jurisprudence_documents for select using (is_public = true);
...
create index if not exists jurisprudence_favorites_user_id_idx on public.jurisprudence_favorites(user_id);
